        ...
        function createUserCharacter() {
            function showPoints() {
                ...
                document.getElementById("displayUserStats").textContent = user.description();
                console.log(user);
            ...
            document.getElementById("increaseLiePoints").addEventListener("click", function () {
                if (user.lie < 10) {
                    ...
                    alert("You already have deception (lie) maxed out!");
                    return
                }
            });
            document.getElementById("decreaseLiePoints").addEventListener("click", function () {
                if (user.lie > 0) {
                    ...
                    alert("You already have deception (lie) to 0")
                }
            });
            document.getElementById("increaseHonestPoints").addEventListener("click", function () {
                if (user.honest < 10) {
                    ...
                    alert("you already have honesty maxed out!");
                    return
                }
            ...
            document.getElementById("decreaseHonestPoints").addEventListener("click", function () {
                if (user.honest > 0) {
                    ...
                    alert("You already have honesty to 0")
                }
            });
            ...
            let user = {
                ...
                damage: 0,
                description() {
                    return `Your honesty is ${this.honest} and your deception is ${this.lie}`
                }
            };
            let totalPoints = 15;
            showPoints();
            ...
            document.getElementById("startGame").addEventListener("click", function () {
                if (totalPoints === 0) {
                    ...
                    alert("Spend all your points first!")
                }
            });
            return user
        };
        ...
        function createComputerCharacter() {
            const characterList = ["king", "minster", "placeholder"];
            ...
            switch (choosenCharacter) {
                ...
                case "placeholder":
                    ...
                    break;
                default:
                    alert("If you see this Martin, you fucked up!")
            };
            let NPC = {
                ...
                damage: 0,
                description() {
                    return `Your enemy is ${this.name} and his honesty is ${this.honest} and his deception is ${this.lie}`
                }
            };
            document.getElementById("displayComputerStats").textContent = NPC.description();
            return NPC
        };
        ...
        function dealDamage(player) {
            if (player === true) {
                ...
                if (userCharacter.health <= 0) {
                    alert("You lost the game! booo.. You suck!")
                    location.reload();
                }
            }
        ...
        function fakeLoadStart() {
            ...
            fakeloaddisplay.style.display = "block";
        ...
        function fakeloadEnd() {
            let fakeloaddisplay = document.getElementById("fakeLoading");
            fakeloaddisplay.style.display = "none";
        }
